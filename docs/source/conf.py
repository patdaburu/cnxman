...
# -*- coding: utf-8 -*-
#
# cnxman documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'cnxman.tex', 'cnxman Documentation',
     'Pat Daburu', 'manual'),
]
...
man_pages = [
    (master_doc, 'cnxman', 'cnxman Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cnxman', 'cnxman Documentation',
     author, 'cnxman', 'One line description of project.',
     'Miscellaneous'),
]
